...
- `claim_next_segment()` returns no work when any capture segment completed successfully in the previous five minutes. This database-backed cooldown applies between every successful segment and is shared by local and remote workers.
