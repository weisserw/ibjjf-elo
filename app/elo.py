...
class EloCompetitor:
    ...
    def beat(self, competitor: "EloCompetitor") -> None:
        ...
        competitor.rating = competitor.rating + competitor._k_factor * (0 - lose_es)
    ...
    def tied(self, competitor: "EloCompetitor") -> None:
        ...
        competitor.rating = competitor.rating + competitor._k_factor * (0.5 - lose_es)
...
DEFAULT_RATINGS = {
    ...
    GREEN_ORANGE: GREEN_DEFAULT_RATINGS,
    ORANGE: ORANGE_DEFAULT_RATINGS,
    YELLOW: YELLOW_DEFAULT_RATINGS,
    YELLOW_GREY: YELLOW_DEFAULT_RATINGS,
