...
class LiveStream(db.Model):
    ...
    drift_factor = Column(Float, nullable=False)
    hide_all = Column(Boolean, nullable=False)
    link = Column(String, nullable=False)
...
class LivestreamFrameArchive(db.Model):
    ...
    preview_s3_key = Column(String, nullable=True)
    preview_content_type = Column(String, nullable=True)
    scoreboard_crop_x = Column(Float, nullable=True)
    scoreboard_crop_y = Column(Float, nullable=True)
    scoreboard_crop_width = Column(Float, nullable=True)
    scoreboard_crop_height = Column(Float, nullable=True)
    timer_crop_x = Column(Float, nullable=True)
