...
Revision ID: eede8d5c5dc5
Revises: 
Create Date: 2024-12-20 01:00:11.585746
...
def upgrade():
    ...
    with op.batch_alter_table('divisions', schema=None) as batch_op:
        batch_op.create_index('ix_divisions_all', ['gi', 'gender', 'age', 'belt', 'weight'], unique=False)
    ...
    with op.batch_alter_table('match_participants', schema=None) as batch_op:
        batch_op.create_index('ix_match_participants_athlete_id', ['athlete_id'], unique=False)
        batch_op.create_index('ix_match_participants_match_id', ['match_id'], unique=False)
        batch_op.create_index('ix_match_participants_team_id', ['team_id'], unique=False)
