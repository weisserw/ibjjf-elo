...
def upgrade():
    ...
    op.create_table('athlete_ratings',
    ...
    sa.UniqueConstraint('athlete_id', 'gender', 'age', 'gi', name='uq_athlete_ratings_athlete_gender_age_gi')
    )
    with op.batch_alter_table('athlete_ratings', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_athlete_ratings_athlete_id', ['athlete_id'], unique=False)
...
def downgrade():
    ...
    op.create_table('current_ratings',
    sa.Column('athlete_id', sa.UUID(), nullable=False),
    sa.Column('rating', sa.FLOAT(), nullable=False),
    ...
    with op.batch_alter_table('current_ratings', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_current_ratings_athlete_id', ['athlete_id'], unique=False)
        batch_op.create_index('ix_current_ratings_all', ['gender', 'age', 'belt', 'gi'], unique=False)
