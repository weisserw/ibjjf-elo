  ...
  return (
    <section className="section">
      <div className="container">
        ...
        <p className="content">
          {t("While we only rank athletes who compete in the International Brazilian Jiu-Jitsu Federation, this site is not affiliated, endorsed by, or associated with the IBJJF.")}
        </p>
        <p className="content">
          {t("The rankings and ratings published here are independent estimates generated by our own methods and data processing.")}
          {` `}
          {t("They do not follow the IBJJF's official ranking standards, rules, or internal processes.")}
        </p>
        <p className="content">
