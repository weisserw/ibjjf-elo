...
interface AppContextProps {
  ...
  bracketEventTotal: number | null;
  setBracketEventTotal: (total: number | null) => void;
...
export const AppProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [openFilters, setOpenFilters] = useLocalStorage<OpenFilters>('openFilters', { athlete: true, event: false, score: false, division: false });
  ...
  const [bracketRegistrationEventName, setBracketRegistrationEventName] = useLocalStorage('bracketRegistrationEventName', '')
  const [bracketRegistrationEventTotal, setBracketRegistrationEventTotal] = useState<number | null>(null)
  const [bracketRegistrationEventUrl, setBracketRegistrationEventUrl] = useLocalStorage('bracketRegistrationEventUrl', '')
  const [bracketRegistrationCategories, setBracketRegistrationCategories] = useState<string[] | null>(null)
  const [bracketRegistrationSelectedCategory, setBracketRegistrationSelectedCategory] = useLocalStorage<string | null>('bracketRegistrationSelectedCategory', null)
