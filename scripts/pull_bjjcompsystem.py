        ...
        with open(output_file, mode="w", newline="") as file:
            ...
            for gender, url in urls:
                ...
                for category in categories:
                    ...
                    age = category.find(
                        "div", class_="category-card__age-division"
                    ).get_text(strip=True)
                    belt = category.find(
                        "span", class_="category-card__belt-label"
                    ).get_text(strip=True)
                    ...
                    matches = category_soup.find_all(
                        "div", class_="tournament-category__match"
                    )

                    num_matches = len(matches)

                    for match in matches:
                        match_when = match.find(
                            "div", class_="bracket-match-header__when"
                        )
                        if match_when:
                            ...
                            match_datetime_iso = ""
                        red_competitor = match.find(
                            "div", class_="match-card__competitor--red"
                        )
                        ...
                        if (
                            not red_competitor_description
                            or not blue_competitor_description
                        ):
                            continue

                        if red_competitor_description.find(
                        ...
                        red_competitor_loser = (
                            ...
                            in red_competitor_description["class"]
                        )
                        ...
                        if blue_competitor_description.find(
                            "div", class_="match-card__bye"
                        ):
                            if (
                                num_matches == 1 and not red_competitor_loser
                            ):  # default gold
                                writer.writerow(
                                    [
                                        args.tournament_id,
                        ...
                        blue_competitor_loser = (
                            "match-competitor--loser"
                            in blue_competitor_description["class"]
                        )
                        ...
                        blue_competitor_note = (
                            blue_competitor_note["title"]
                            if blue_competitor_note
                            else ""
                        )
